            ...
            steps {
               ...
               script {
                    if(env.GIT_BRANCH == "origin/main") {
                         ...
                         sshPublisher(publishers: [sshPublisherDesc(configName: 'daniyal-dev', transfers: [sshTransfer(execCommand: "wget -qO- https://raw.githubusercontent.com/nvm-sh/nvm/v0.35.3/install.sh | bash; wget -qO- https://getpm2.com/install.sh | bash; pm2 stop server; pm2 start server.js",sourceFiles: 'server.js')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])
