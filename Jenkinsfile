            ...
            steps {
               ...
               script {
                    if(env.GIT_BRANCH == "origin/main") {
                         ...
                         sshPublisher(publishers: [sshPublisherDesc(configName: 'daniyal-develop', transfers: [sshTransfer(execCommand: "npm install; wget -qO- https://getpm2.com/install.sh | bash; pm2 stop server; pm2 start server.js",sourceFiles: 'server.js')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])
